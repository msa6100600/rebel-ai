...
export default function ProjectsScreen() {
  ...
  const remove = (project: Project) => Alert.alert("حذف المشروع؟", "ستبقى محادثاته وذكرياته في حسابك، لكنها لن تكون مرتبطة بهذا المشروع بعد الحذف.", [
