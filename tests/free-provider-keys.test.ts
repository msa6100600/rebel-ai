...
describe("free model provider credentials", () => {
  it("validates Gemini Flash access", async () => {
  ...
  it("validates Groq model catalog access", async () => {
  ...
  it("validates Mistral model catalog access", async () => {
